 ...
 */
function chanmomoroom_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Chanmomoroom default saturation level.
	 *
	 * @since Chanmomoroom 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'chanmomoroom_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.chanmomoroom-front-page) .entry-title,
...
.colors-custom .chanmomoroom-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.chanmomoroom-front-page .panel-content .recent-posts article,
...
.colors-custom.chanmomoroom-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Chanmomoroom custom colors CSS.
	 *
	 * @since Chanmomoroom 1.0
	 *
	 ...
	 */
	return apply_filters( 'chanmomoroom_custom_colors_css', $css, $hue, $saturation );
}
