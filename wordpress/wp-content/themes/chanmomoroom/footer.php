		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			<div class="wrap">
				...
				if ( has_nav_menu( 'social' ) ) : ?>
					<nav class="social-navigation" role="navigation" aria-label="<?php _e( 'Footer Social Links Menu', 'chanmomoroom' ); ?>">
						<?php
							wp_nav_menu( array(
								...
								'link_after'     => '</span>' . chanmomoroom_get_svg( array( 'icon' => 'chain' ) ),
							) );
						?>
